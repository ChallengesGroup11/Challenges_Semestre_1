 ...
 */
final class Version20230401161559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT NOT NULL, driving_school_id_id INT DEFAULT NULL, slot_begin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slot_end TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, comment VARCHAR(255) DEFAULT NULL, status_validate BOOLEAN NOT NULL, status_done BOOLEAN NOT NULL, PRIMARY KEY(id))');
