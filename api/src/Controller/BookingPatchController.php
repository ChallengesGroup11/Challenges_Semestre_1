...
class BookingPatchController extends AbstractController
{
  ...
  public function __invoke(Booking $booking, Request $request , SerializerInterface $serializer, StudentRepository $studentRepository, EntityManagerInterface $em): JsonResponse
  {
