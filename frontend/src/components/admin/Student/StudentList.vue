...
const fetchStudentInfo = async () => {
  return fetch('https://localhost/students')
    .then((response) => response.json())
    .then((data) => {
...
const deleteStudent = async (id: string) => {
  const response = await fetch('https://localhost/students/' + id, {
    method: 'DELETE',
    headers: {
...
const changeStatus = async (id: string) => {
  const response = await fetch('https://localhost/students/' + id + '/edit_status', {
    method: 'PATCH',
    headers: {
      'accept': 'application/ld+json',
